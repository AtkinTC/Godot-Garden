...
const templates := {
	...
	Const.PURCHASE : {
		...
		Const.LOCAL_MODIFIERS : OPTIONAL + ARRAY_OF_DICTIONARY
	},
	Const.BUILD : {
		Const.LENGTH : OPTIONAL
	},
	Const.LOCAL_MODIFIERS : {
		Const.LOCAL_MOD_TARGET : REQUIRED,
		Const.LOCAL_MOD_TYPE : REQUIRED
	},
	Const.SOURCE : {
		Const.GAIN : OPTIONAL + DICTIONARY,
		Const.CAPACITY : OPTIONAL + DICTIONARY
	},
	Const.GAIN : {
		Const.VALUE : REQUIRED,
		Const.LOCAL_MODIFIERS : OPTIONAL + ARRAY_OF_DICTIONARY
