...
@onready var available_display_content : PackedScene = load("res://Scenes/Garden/PlotDisplay/Content/PlotDisplayAvailableContent.tscn")
...
func update_display() -> void:
	...
	if(plot.is_available() && !plot.is_owned()):
		plot_display_content = available_display_content.instantiate()
		plot_display_content.init(plot_coord)
	if(plot_display_content != null && is_instance_valid(plot_display_content)):
